 ...
 * Desc: Implements a binary search tree of Strings
 * 
...
public class BSTString implements BMCSet<String>
{
	private Node<String> root; // the root of the tree
	 ...
	 */
	public boolean addIter(String item)
	{
		if(root == null)
		{
			root = new Node<>(item);
	 ...
	 */
	private Node<String> addRec(Node<String> where, String item)
	{
		if(where == null)
		{
			size++;
	 ...
	 */
	public boolean containsIter(String item)
	{
		Node<String> current = root;
	 ...
	 */
	private boolean containsRec(Node<String> where, String item)
	{
		if(where == null)
		{
			return false;
	 ...
	 */
	private Node<String> removeRec(Node<String> where, String item)
	{
		if(where == null)
		{
	 ...
	 */
	private String findLargestChild(Node<String> parent)
	{
		if(parent.right.right == null)
		{
			String returnValue = parent.right.data;
	 ...
	 */
	private void printInOrderRec(Node<String> where)
	{
		if(where != null)
		{

...
class TreeTest
{
	...
	void testIterator()
	{
		...
		Iterator<String> itor = tree.iterator();
		assertEquals(itor.next(), "chicken");
		assertEquals(itor.next(), "goat");
		assertEquals(itor.next(), "jackrabbit");
		assertEquals(itor.next(), "pig");
		assertEquals(itor.next(), "rat");
	}
}
